...
describe('move', () => {
  ...
  it('throws error if given source file doesnt exists', () => {
    const list = [
      {
        id: '1',
        name: 'Folder 1',
    ...
    expect(() => move(list, '5', '1')).toThrow('Source file does not exists');
  });

  it('throws error if given destination folder doesnt exists', () => {
    const list = [
      {
        id: '1',
        name: 'Folder 1',
    ...
    expect(() => move(list, '2', '5')).toThrow('Destination folder not exists');
  });

  it('throws error if source file name already exists on destination folder', () => {
    const list = [
      {
        id: '1',
        name: 'Folder 1',
      ...
      { id: '3', name: 'Folder 2', files: [{ id: '4', name: 'File 1' }] },
    ];

    expect(() => move(list, '2', '3')).toThrow(
      'The given name of source element already exists on destination folder',
    );
  });
});
